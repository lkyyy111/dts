...
type User struct {
	...
	AvatarRemoteURL string `json:"avatar_remote_url" gorm:"column:avatar_remote_url;type:text;not null;default:''"`
	...
	ServerCreated   int64  `json:"-" gorm:"column:server_created;not null;default:0;index"`
}
...
type Post struct {
	...
	PosterID  string `json:"poster_id" gorm:"column:poster_id;type:varchar(26);not null;index"`
